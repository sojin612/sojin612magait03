...
<script>
	...
	function formValidationCheck() {
		...
		var writer = document.f.writer;//왜 document.f.writer인가요??document.form의 name. name
		...
		return true; //if문에서 폴즈가 됐는데 if문 빠져나온후 다시 트루가 되는게 아닌가??false를 만나면 함수가 끝남.이프문밖으로 안내려옴.
