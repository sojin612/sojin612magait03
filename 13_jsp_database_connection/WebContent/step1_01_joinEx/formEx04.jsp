...
<script>
	...
	function formCheck() {
		...
		var agreePrivateInform = document.getElementById("agreePrivateInform");
		
		if(!agreePrivateInform.checked){
			alert("개인정보 수집에 동의하셔야 합니다.");
			agreePrivateInform.focus();
			return false;
		}
...
<body>
	...
	<form method="post" action="formEx04Pro.jsp" onsubmit="return formCheck()">
		<fieldset>
