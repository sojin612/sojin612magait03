...
<body>
	<div align="center" style="padding-top: 100px">
		<form action="boardWriteAction.do" name="f" method="post" onsubmit="return formValidationCheck()">
			<div  align="center">
				<h2>게시글 쓰기</h2>
				<br>
			</div>
			<table style="width: 700px;" border="1">
				...
				<tr align="center">
					<td colspan="2">
						...
						<input type="button" onclick="location.href='boardList.do'" value="전체게시글보기">
					</td>
				</tr>
			</table>
		</form>
